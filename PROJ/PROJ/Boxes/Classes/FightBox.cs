...
public class FightBox : Box
{
    ...
    public void AfterMoveAssesment(Enemy? enemy)
    {
        if (enemy == null)
        {
            ClearInside();
    ...
    public void DisplayConcreteEnemy(Enemy e)
    {
    ...
    public void FightMode(Player p,Enemy e)
    {
        ClearInside();
        
        Console.SetCursorPosition(GameConstants.FightBoxPlayerLeftHand, GameConstants.FightBoxPlayerIconTop);
        Console.Write(p.LeftHand != null ? p.LeftHand.Visual : GameConstants.EmptyHandSymbol);
        ...
        Console.Write(p.RightHand != null ? p.RightHand.Visual : GameConstants.EmptyHandSymbol);
    ...
    private void TypeLeftHand(ConsoleColor? color, Player p)
    {
        Console.SetCursorPosition(GameConstants.FightBoxPlayerLeftHand, GameConstants.FightBoxPlayerIconTop);
        if(color!=null) 
            Console.ForegroundColor = (ConsoleColor)color;
    ...
    private void TypeRightHand(ConsoleColor? color, Player p)
    {
        Console.SetCursorPosition(GameConstants.FightBoxPlayerRightHand, GameConstants.FightBoxPlayerIconTop);
        if(color!=null) 
            Console.ForegroundColor = (ConsoleColor)color;
    ...
    private void ClearPreviousHand(Player p)
    {
        TypeLeftHand(null,p);
        TypeRightHand(null,p);
    }
    public void HighlightHand(char hand, Player p)
    {
        ClearPreviousHand(p);
        if(hand == 'L')
    ...
    public void UpdateEnemyVitals(Enemy e)
    {
        Console.SetCursorPosition(GameConstants.FightBoxEnemyVitalsLeft, GameConstants.FightBoxEnemyVitalsTop);
        Console.Write("           ");
        Console.SetCursorPosition(GameConstants.FightBoxEnemyVitalsLeft, GameConstants.FightBoxEnemyVitalsTop);
    ...
    public void DeadEnemyDisplay(Enemy e)
    {
        ClearInside();
